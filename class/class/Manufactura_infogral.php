...
class Historial_manufac
{
	...
	if ( $select_manufac_global_plaza[0] == 3 ){
		$sql = "SELECT * FROM
				...
				FROM op_in_solicitud_otros s_o WHERE s_o.id_plaza = 3 ) ORDER BY TO_DATE(fecha,'dd-mm-yyyy') DESC ";
		$stid = oci_parse($conn, $sql);
		oci_execute($stid );
	...
	if ( $select_manufac_global_plaza[1] == 4 ){
		$sql = "SELECT * FROM
				(SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 4 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0) AND s_c_d.iid_regimen = 1
				UNION
				SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 4 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0) AND s_c_d.iid_regimen = 2
				UNION
				SELECT TO_CHAR( s_o.d_fecha_registro,  'dd-mm-yyyy') AS fecha, s_o.id_plaza AS id_plaza
				FROM op_in_solicitud_otros s_o WHERE s_o.id_plaza = 4 ) ORDER BY TO_DATE(fecha,'dd-mm-yyyy') DESC ";
		$stid = oci_parse($conn, $sql);
		oci_execute($stid );
	...
	if ( $select_manufac_global_plaza[2] == 5 ){
		$sql = "SELECT * FROM
				(SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 5 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0) AND s_c_d.iid_regimen = 1
				UNION
				SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 5 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0) AND s_c_d.iid_regimen = 2
				UNION
				SELECT TO_CHAR( s_o.d_fecha_registro,  'dd-mm-yyyy') AS fecha, s_o.id_plaza AS id_plaza
				FROM op_in_solicitud_otros s_o WHERE s_o.id_plaza = 5 ) ORDER BY TO_DATE(fecha,'dd-mm-yyyy') DESC ";
		$stid = oci_parse($conn, $sql);
		oci_execute($stid );
	...
	if ( $select_manufac_global_plaza[3] == 6 ){
		$sql = "SELECT * FROM
				(SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 6 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0)
				UNION
				SELECT TO_CHAR( s_o.d_fecha_registro,  'dd-mm-yyyy') AS fecha, s_o.id_plaza AS id_plaza
				FROM op_in_solicitud_otros s_o WHERE s_o.id_plaza = 6  AND s_c_d.n_virtual is null or s_c_d.n_virtual = 0 ) ORDER BY TO_DATE(fecha,'dd-mm-yyyy') DESC ";
		$stid = oci_parse($conn, $sql);
		oci_execute($stid );
	...
	if ( $select_manufac_global_plaza[4] == 7 ){
		$sql = "SELECT * FROM
				(SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 7 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0) AND s_c_d.iid_regimen = 1
				UNION
				SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 7 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0) AND s_c_d.iid_regimen = 2
				UNION
				SELECT TO_CHAR( s_o.d_fecha_registro,  'dd-mm-yyyy') AS fecha, s_o.id_plaza AS id_plaza
				FROM op_in_solicitud_otros s_o WHERE s_o.id_plaza = 7 ) ORDER BY TO_DATE(fecha,'dd-mm-yyyy') DESC ";
		$stid = oci_parse($conn, $sql);
		oci_execute($stid );
	...
	if ( $select_manufac_global_plaza[5] == 8 ){
		$sql = "SELECT * FROM
				(SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 8 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0) AND s_c_d.iid_regimen = 1
				UNION
				SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 8 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0) AND s_c_d.iid_regimen = 2
				UNION
				SELECT TO_CHAR( s_o.d_fecha_registro,  'dd-mm-yyyy') AS fecha, s_o.id_plaza AS id_plaza
				FROM op_in_solicitud_otros s_o WHERE s_o.id_plaza = 8 ) ORDER BY TO_DATE(fecha,'dd-mm-yyyy') DESC ";
		$stid = oci_parse($conn, $sql);
		oci_execute($stid );
	...
	if ( $select_manufac_global_plaza[6] == 17 ){
		$sql = "SELECT * FROM
				(SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 17 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0) AND s_c_d.iid_regimen = 1
				UNION
				SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 17 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0) AND s_c_d.iid_regimen = 2
				UNION
				SELECT TO_CHAR( s_o.d_fecha_registro,  'dd-mm-yyyy') AS fecha, s_o.id_plaza AS id_plaza
				FROM op_in_solicitud_otros s_o WHERE s_o.id_plaza = 17 ) ORDER BY TO_DATE(fecha,'dd-mm-yyyy') DESC ";
		$stid = oci_parse($conn, $sql);
		oci_execute($stid );
	...
	if ( $select_manufac_global_plaza[7] == 18 ){
		$sql = "SELECT * FROM
				(SELECT TO_CHAR( s_c_d.d_fec_recepcion,  'dd-mm-yyyy') AS fecha, s_c_d.id_plaza AS id_plaza
				FROM op_in_solicitud_carga_descarga s_c_d WHERE s_c_d.id_plaza = 18 AND (s_c_d.n_virtual is null or s_c_d.n_virtual = 0)
				UNION
				SELECT TO_CHAR( s_o.d_fecha_registro,  'dd-mm-yyyy') AS fecha, s_o.id_plaza AS id_plaza
				FROM op_in_solicitud_otros s_o WHERE s_o.id_plaza = 18 ) ORDER BY TO_DATE(fecha,'dd-mm-yyyy') DESC ";
		$stid = oci_parse($conn, $sql);
		oci_execute($stid );
