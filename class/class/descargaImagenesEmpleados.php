...
//  var_dump($content);
  ...
  ftp_close($conn_id);
	...
	public function descargaImagenesEmpleados(){
		$local_file = '/var/www/html/dashboard/imagenes_Empleados/';//Ruta local donde guardara archivos
	  $server_file = '/home/soldet/empleados/';//Ruta de servidor ftp donde se encuentran archivos a copiar
