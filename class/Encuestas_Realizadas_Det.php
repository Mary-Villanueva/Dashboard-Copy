...
if(isset($_POST["encuesta"]))
{
	...
	$encuesta = 0;
		...
		$sql = "SELECT ENCD.ID_CONSECUTIVO,
						...
						(SELECT ENDS.SUBPREGUNTA ||' PLAZA: '|| (SELECT PLAZA.V_RAZON_SOCIAL FROM PLAZA WHERE PLAZA.IID_PLAZA = ENCP.IID_PLAZA) FROM AD_SGC_ENCUESTA_SUBPREGUNTA ENDS WHERE ENDS.ID_SUBPREGUNTA = ENCD.ID_SUBPREGUNTA AND ENDS.ID_PREGUNTA = ENCP.ID_PREGUNTA AND ENCP.TIPO_ENCUESTA = ENDS.TIPO_ENCUESTA)
						...
						WHERE ENCE.CONSECUTIVO_ENC =  $encuesta  ORDER BY (CASE WHEN ENDS.SUBPREGUNTA IS NOT NULL THEN
                 1
             ELSE 2 END), ENCD.ID_CONSECUTIVO , ENCD.ID_SUBPREGUNTA ";
