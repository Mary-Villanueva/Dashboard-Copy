<!-- INICIA CODE PARA EL MODAL DE CARGANDO -->
  <div class="modal fade" id="modal_cargando" data-backdrop="static" role="dialog">
...
<!-- MANTIENEN Sidebar Collapsed ON OFF-->
<script>
  $(function () {
...
$('.click_modal_cargando').click(function(){
  $.ajax({url: '../class/Perfil.php', success: function(result){
