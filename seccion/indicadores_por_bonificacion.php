...
$modulos_valida = Perfil::modulos_valida($_SESSION['iid_empleado'], 54);
if($modulos_valida == 0)
{
  header('Location: index.php');
}
///////////////////////////////////////////
include '../class/indicador_por_bon.php';
...
<div class="content-wrapper"><!-- Inicia etiqueta content-wrapper principal -->
  <section class="content-header">
    <h1>Dashboard<small>INDICE DE EMISION DE NOTAS DE CREDITO (Bonificacion)</small></h1>
  ...
  <section>
                      ...
                      <table id="tabla_nomina" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                          <tr>
                            ...
                            <th class="small" bgcolor="#43ADBF"><font color="white">NO BONIFICACIONES</font></th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                          ...
                          <tr>
                            ...
                            <td class="small"><?= $graficaDetalleAlmacen[$i]["CANTIDAD_DEB"] ?></td>
                            <?php $cantidad_valores = $cantidad_valores+$graficaDetalleAlmacen[$i]["CANTIDAD_DEB"];?>
                          </tr>
                          <?php } ?>
                          ...
                          <tr>
                            <th>Criterio</th>
                            <th><?php $criterio = $cantidad_valores/4; echo $criterio; ?></th>
                          </tr>
                          <tr>
                            <th>Ponderación</th>
                            <th>
                                <?php
                                if ($criterio >= 0 and $criterio <= 5.99) {
                                  $valor = "100%";
                                  $color1 = "#43ADBF";
                                  $color2 = "white";
                                  $color3 = "white";
                                  ...
                                  $colort5 = "black";
                                  $colort6 = "black";
                                }elseif ($criterio >= 6 and $criterio <= 10.99) {
                                  $valor = "90%";
                                  $color1 = "white";
                                  $color2 = "#43ADBF";
                                  $color3 = "white";
                                  ...
                                  $colort5 = "black";
                                  $colort6 = "black";
                                }elseif ($criterio >= 11 and $criterio <= 20.99) {
                                  $valor = "80%";
                                  $color1 = "white";
                                  $color2 = "white";
                                  $color3 = "#43ADBF";
                                  ...
                                  $colort5 = "black";
                                  $colort6 = "black";
                                }elseif ($criterio >= 21 and $criterio <= 30.99) {
                                  $valor = "70%";
                                  $color1 = "white";
                                  $color2 = "white";
                                  $color3 = "white";
                                  ...
                                  $colort5 = "black";
                                  $colort6 = "black";
                                }elseif ($criterio >= 31 and $criterio <= 40.99) {
                                  $valor = "60%";
                                  $color1 = "white";
                                  $color2 = "white";
                                  $color3 = "white";
                                  ...
                                  $colort5 = "white";
                                  $colort6 = "black";
                                }elseif ($criterio >= 41 and $criterio <= 50.99) {
                                  $valor = "50%";
                                  $color1 = "white";
                                  $color2 = "white";
                                  $color3 = "white";
                    ...
                    <div class="table-responsive" id="container">
                      <table id="tabla_nomina3" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                          <tr>
                            <!--<th class="small" bgcolor="#2a7a1a"><font color="white">ID</font></th>-->
                            <th class="small" bgcolor="#43ADBF"><font color="white">Criterio (De Efectividad)</font></th>
                        ...
                        <tbody>
                          <tr>
                            <td class="small"  bgcolor="<?= $color1 ?>"><font color="<?= $colort1 ?>">A) 0 a 5.99 Notas de Crédito</font></td>
                          ...
                          <tr>
                            <td class="small" bgcolor="<?= $color2 ?>"><font color="<?= $colort2 ?>">B) 6 a 10.99 Notas de Crédito</font></td>
                          ...
                          <tr>
                            <td class="small" bgcolor="<?= $color3 ?>"><font color="<?= $colort3 ?>">C) 11 a 20.99 Notas de Crédito</font></td>
                          ...
                          <tr>
                            <td class="small" bgcolor="<?= $color4 ?>"><font color="<?= $colort4 ?>">D) 21 a 30.99 Notas de Crédito</font></td>
                          ...
                          <tr>
                            <td class="small" bgcolor="<?= $color5 ?>"><font color="<?= $colort5 ?>">E) 31 a 40.99 Notas de Crédito</font></td>
                            <td class="small" bgcolor="<?= $color5 ?>"><font color="<?= $colort5 ?>">60%</font></td>
                            <td class="small" bgcolor="<?= $color5 ?>"><font color="<?= $colort5 ?>">Malo</font></td>
                          </tr>
                          <tr>
                            <td class="small" bgcolor="<?= $color6 ?>"><font color="<?= $colort6 ?>">F) 41 a 50 Notas de Crédito</font></td>
    ...
    <div class="box box-info">
      <div class="box-header with-border">
        ...
        <a href="indicadores_por_bonificacion.php"><button class="btn btn-sm btn-warning">Borrar Filtros <i class="fa fa-close"></i></button></a>
        <?php } ?>
        <div class="box-tools pull-right">
          <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
        </div>
    ...
    dom: 'lBfrtip',//Bfrtip muestra opcion para ver n registros
        buttons: [

          {
            ...
            title: 'Indice de emision de notas de credito BONIFICACIÓN',
          },
