...
function Header(){
        ...
        $this -> Image('../assets/img/backgrounds/logo_nuevo.png', 10,8, 33);
        $this -> SetFont('Arial', 'B', 12);
        $this -> Cell(25);
        $this -> Cell(150, 10, utf8_decode('ARGO ALMACENADORA'), 0, 0, 'C');
        $this -> Cell(2);
        for ($i=0; $i <count($minuta_Gral) ; $i++) {
          $this -> Cell(1, 10, $minuta_Gral[$i]["FECHA_REALIZA_SOLICITUD"], 0, 0, 'C');
