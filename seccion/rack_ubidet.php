						...
						$.ajax({
                            ...
                            for(var k in dataJson) {
								...
								var v_detalle = $.trim(dataJson[k].DETALLE1+" "+dataJson[k].DETALLE2);
	               		    	var s_bateria = v_ubicacion.substr(0, 1);
	                   		    var s_columna = v_ubicacion.substr(1, 2);
	                   		    var s_nivel = v_ubicacion.substr(3, 2);
	                   		    var s_posicion = v_ubicacion.substr(5, 2);
	                   		    var s_profundidad = v_ubicacion.substr(7, 2);
