...
$modulos_valida = Perfil::modulos_valida($_SESSION['iid_empleado'], '41');
if($modulos_valida == 0)
{
  header('Location: index.php');
}
...
include_once '../class/Manufactura_infogral_Alo.php';
...
include_once '../class/Manufactura_Alo.php';
            ...
            <div class="table-responsive">
              ...
              ?>
                <tr>
                  ...
                  <td class="small"><?= $info_manufac_car_des[$i]["PROYECTO_RECIBO"] ?></td>
                  <td class="small">
                  <!-- INICIA CODE QUE MUESTRA EL ARRIBO O SOLICITUD DEPENDIENDO LA PLAZA -->
                  <?php
            ...
            <div class="table-responsive">
              ...
              ?>
                <tr>
                  ...
                  <td class="small"><?= $info_manufac_car_des[$i]["CANTIDAD"] ?></td>
                  <td class="small"><?= $info_manufac_car_des[$i]["ALMACENISTA_N"]." ".$info_manufac_car_des[$i]["ALMACENISTA_P"]." ".$info_manufac_car_des[$i]["ALMACENISTA_M"] ?></td>
                  <td class="small"><?= $info_manufac_car_des[$i]["PROYECTO_ARRIBO"] ?></td>
                  <td class="small">
