...
$modulos_valida = Perfil::modulos_valida($_SESSION['iid_empleado'], '35');
if($modulos_valida == 0)
{
  header('Location: index.php');
}
...
<!-- ############################ INICIA SECCION GRAFICA GLOBAL CARGAS-DECARGAS-OTROS ############################# -->
<section>
  <div class="box box-primary">
    ...
    <h5 class="text-blue text-center"><i class="fa fa-bar-chart"></i> GRAFICA DE OPERACIONES MANUFACTURA EN PLAZAS</h5><hr>
    ...
    <style type="text/css">
      ...
      <div id="bar-chart-global" style="height: 300px; "></div><br>

    </div><!--/.box-body-->
  </div>
</section>
<!-- ########################### TERMINA SECCION GRAFICA GLOBAL CARGAS-DECARGAS-OTROS ########################### -->
...
<section style="display:none">
  ...
  <!-- *************** INICIA TABLA DE INFO GENERAL CARGAS *************** -->
    <div class="col-md-6">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"></h3>
        ...
        <div class="box-body"><!--box-body-->
          ...
          <div class="box box-widget widget-user-2">
            ...
            <button style="background-color:#C8E6C9;" type="button" id="boton_carga_tiem" value="EnTiempo" class="btn btn-xs">EnTiempo</button>
            <button style="background-color:#FFCDD2;" type="button" id="boton_carga_retr" value="EnRetraso" class="btn btn-xs">EnRetraso</button>

            <table id="tabla_alm_carga" class="table display compact" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th class="small">ALMACEN</th>
                  <th class="small">PLAZA</th>
                  <th class="small">STATUS</th>
                  <th class="small">ANDEN</th>
              ...
              <tbody>
              <?php
              $info_gral_car_des_otr_cor = $obj_info_gral_manufactura->info_gral_car_des_otr_cor($dia_manufac,$select_manufac_global_plaza,$fec_ini_per_manufac,$fec_fin_per_manufac);
              for ($i=0; $i <count($info_gral_car_des_otr_cor) ; $i++) {

                if ($info_gral_car_des_otr_cor[$i]["ID_STATUS"]==1){
                  //--//
                  switch (true) {
                  case ( $info_gral_car_des_otr_cor[$i]["REGISTRADO"] == false ):
                     $calculo_tiempo = "<code>error no se registró tiempo</code>";
                    break;
                  default:
                    $fechaFin_car_gen = strftime("%d-%m-%Y %H:%M:%S");
                    $calculo_tiempo = $obj_info_gral_manufactura->calculo_tiempo($info_gral_car_des_otr_cor[$i]["REGISTRADO"],$fechaFin_car_gen);
                    $calculo_minutos = $obj_info_gral_manufactura->dif_minutos($fechaFin_car_gen,$info_gral_car_des_otr_cor[$i]["REGISTRADO"]);
                    break;
                  }
                  //--//
                }else{
                  //--  --//
                  switch (true) {
                  case ( $info_gral_car_des_otr_cor[$i]["H_LLEGADA"] == false ):
                     $calculo_tiempo = "<code>error no se registró tiempo</code>";
                    break;
                  case ( $info_gral_car_des_otr_cor[$i]["H_DESPACHO"] == true ):
                    $fechaFin_car_gen = $info_gral_car_des_otr_cor[$i]["H_DESPACHO"] ;
                    $calculo_tiempo = $obj_info_gral_manufactura->calculo_tiempo($info_gral_car_des_otr_cor[$i]["H_LLEGADA"],$fechaFin_car_gen);
                    $calculo_minutos = $obj_info_gral_manufactura->dif_minutos($fechaFin_car_gen,$info_gral_car_des_otr_cor[$i]["H_LLEGADA"]);
                    break;
                  default:
                    $fechaFin_car_gen = strftime("%d-%m-%Y %H:%M:%S");
                    $calculo_tiempo = $obj_info_gral_manufactura->calculo_tiempo($info_gral_car_des_otr_cor[$i]["H_LLEGADA"],$fechaFin_car_gen);
                ...
                if ( $info_gral_car_des_otr_cor[$i]["TIPO_OP"] == 1 ){
                  if ( $calculo_minutos < 90 || $info_gral_car_des_otr_cor[$i]["ID_STATUS"] == 6 || $info_gral_car_des_otr_cor[$i]["ID_STATUS"] <= 4 ){

                  /* DEFINE COLOR DEPENDIENDO DEL TEIMPO */
                  if ( $calculo_minutos > 90){
                    $bgcolor = "#FFCDD2";
              ...
              ?>
                <tr bgcolor="<?=$bgcolor?>">
                  <td class="small"><?= $info_gral_car_des_otr_cor[$i]["ALMACEN"] ?></td>
                  <td class="small"><?= $info_gral_car_des_otr_cor[$i]["PLAZA_SIG"] ?></td>

              <?php
                switch ($info_gral_car_des_otr_cor[$i]["ID_STATUS"]) {
                  case 0:
                  case 1:
                  case 2:
                  case 3:
                  case 4:
                    echo '<td class="small text-blue">'.$info_gral_car_des_otr_cor[$i]["STATUS"].'</td>';
                    /*--INICIA CREACION DE VARIABLES PARA CARGAS EN PROCESO EN CADA PLAZA--*/
                    switch ($info_gral_car_des_otr_cor[$i]["PLAZA_ID"]) {
                      case 3:
                        $cargas_proceso_cor[$i] = $i;
                        break;
                      case 4:
                        $cargas_proceso_mex[$i] = $i;
                        break;
                      case 5:
                        $cargas_proceso_gol[$i] = $i;
                        break;
                      case 6:
                        $cargas_proceso_pen[$i] = $i;
                        break;
                      case 7:
                        $cargas_proceso_pue[$i] = $i;
                        break;
                      case 8:
                        $cargas_proceso_baj[$i] = $i;
                        break;
                      case 17:
                        $cargas_proceso_occ[$i] = $i;
                        break;
                      case 18:
                        $cargas_proceso_nor[$i] = $i;
                        break;
                      case 23:
                        $cargas_proceso_leo[$i] = $i;
                        break;
                    }
                    /*--TERMINA CREACION DE VARIABLES PARA CARGAS EN PROCESO EN CADA PLAZA--*/
                    break;
                  case 5:
                    echo '<td class="small text-green">'.$info_gral_car_des_otr_cor[$i]["STATUS"].'</td>';
                    /*--INICIA CREACION DE VARIABLES PARA CARGAS FINALIZADAS EN CADA PLAZA--*/
                    switch ($info_gral_car_des_otr_cor[$i]["PLAZA_ID"]) {
                      case 3:
                        $cargas_finalizadas_cor[$i] = $i;
                        break;
                      case 4:
                        $cargas_finalizadas_mex[$i] = $i;
                        break;
                      case 5:
                        $cargas_finalizadas_gol[$i] = $i;
                        break;
                      case 6:
                        $cargas_finalizadas_pen[$i] = $i;
                        break;
                      case 7:
                        $cargas_finalizadas_pue[$i] = $i;
                        break;
                      case 8:
                        $cargas_finalizadas_baj[$i] = $i;
                        break;
                      case 17:
                        $cargas_finalizadas_occ[$i] = $i;
                        break;
                      case 18:
                        $cargas_finalizadas_nor[$i] = $i;
                        break;
                      case 23:
                        $cargas_finalizadas_leo[$i] = $i;
                        break;
                    }
                    /*--TERMINA CREACION DE VARIABLES PARA CARGAS FINALIZADAS EN CADA PLAZA--*/
                    break;
                  case 6:
                    echo '<td class="small text-red">'.$info_gral_car_des_otr_cor[$i]["STATUS"].'</td>';
                    $cargas_canceladas_cor[$i] = $i;
                    break;
                }
              ?>
                  <td class="small"><span class="badge bg-blue"><?= $info_gral_car_des_otr_cor[$i]["ANDEN"] ?></span></td>
                  <td class="small"><?= $info_gral_car_des_otr_cor[$i]["CLIENTE"] ?></td>
                  <td class="small"><?= $calculo_tiempo ?><br><cite>(<?=$var_tiempo?>)</cite></td>
                  <td class="small">
                  <form method="post">
                  <input type="hidden" name="plaza_manufac" value="<?=$info_gral_car_des_otr_cor[$i]["PLAZA"]?>">
                  <div id="cargando_img_cargas<?=$info_gral_car_des_otr_cor[$i]["SOLICITUD"]?>">
                  <button type="submit" class="btn btn-sm badge bg-blue click_cargando_cargas<?=$info_gral_car_des_otr_cor[$i]["SOLICITUD"]?>"><i class="fa fa-search"></i> VER</button>
                  <!-- INICIA CODE NOTIFICACION -->
                  <!-- <br><button type="button" class="btn btn-sm badge bg-green" data-toggle="modal" data-target="#modal_what<?=$info_gral_car_des_otr_cor[$i]["SOLICITUD"]?>"> <i class="fa fa-whatsapp"></i> Notificar</button> -->
                  <!-- TERMINA CODE NOTIFICACION -->
                  </div>
                  <div id="cargando_text_cargas<?=$info_gral_car_des_otr_cor[$i]["SOLICITUD"]?>"></div>
                  </form>
                  </td>
                </tr>

                <!-- MODAL WHATSAPP-->
                <div class="modal fade" id="modal_what<?=$info_gral_car_des_otr_cor[$i]["SOLICITUD"]?>" role="dialog">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <input type="hidden" name="caja_texto" id="valor2<?=$info_gral_car_des_otr_cor[$i]["SOLICITUD"]?>" value="<?php echo 'Carga '.$var_tiempo.' *Almacen:* '.$info_gral_car_des_otr_cor[$i]["ALMACEN"].' *Plaza:* '.$info_gral_car_des_otr_cor[$i]["PLAZA"].' *Status:* '.$info_gral_car_des_otr_cor[$i]["STATUS"].' *Anden:* '.$info_gral_car_des_otr_cor[$i]["ANDEN"].' *Cliente:* '.$info_gral_car_des_otr_cor[$i]["CLIENTE"].' *Tiempo:*'.$calculo_tiempo ?>"/>
                        ...
                        <div class="callout callout" style="background: <?=$bgcolor?>">
                          ...
                          <b>Almacen: </b>  <?= $info_gral_car_des_otr_cor[$i]["ALMACEN"] ?><br>
                          <b>Plaza: </b> <?= $info_gral_car_des_otr_cor[$i]["PLAZA"] ?><br>
                          <b>Status: </b> <?= $info_gral_car_des_otr_cor[$i]["STATUS"] ?><br>
                          <b>Anden: </b> <?= $info_gral_car_des_otr_cor[$i]["ANDEN"] ?><br>
                          <b>Cliente: </b> <?= $info_gral_car_des_otr_cor[$i]["CLIENTE"] ?><br>
                          <b>Tiempo: </b> <?= $calculo_tiempo ?><br>
                        </div>
  ...
  <!-- *************** TERMINA TABLA DE INFO GENERAL CARGAS *************** -->
  <!-- *************** INICIA TABLA DE INFO GENERAL DESCARGAS *************** -->
    <div class="col-md-6">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"></h3>
        ...
        <div class="box-body"><!--box-body-->
          ...
          <div class="box box-widget widget-user-2">
            ...
            <button style="background-color:#C8E6C9;" type="button" id="boton_descarga_tiem" value="EnTiempo" class="btn btn-xs">EnTiempo</button>
            <button style="background-color:#FFCDD2;" type="button" id="boton_descarga_retr" value="EnRetraso" class="btn btn-xs">EnRetraso</button>

            <table id="tabla_alm_descarga" class="table display compact" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th class="small">ALMACEN</th>
                  <th class="small">PLAZA</th>
              ...
              for ($i=0; $i <count($info_gral_car_des_otr_cor) ; $i++) {
                ...
                //--  --//
                if ( $info_gral_car_des_otr_cor[$i]["TIPO_OP"] == 2 ){
                  if ( $calculo_minutos < 90 || $info_gral_car_des_otr_cor[$i]["ID_STATUS"] == 6 || $info_gral_car_des_otr_cor[$i]["ID_STATUS"] <= 4 ){
              ...
              <?php
                switch ($info_gral_car_des_otr_cor[$i]["ID_STATUS"]) {
                  ...
                  case 4:
                    echo '<td class="small text-blue">'.$info_gral_car_des_otr_cor[$i]["STATUS"].'</td>';
                    /*--INICIA CREACION DE VARIABLES PARA DESCARGAS EN PROCESO EN CADA PLAZA--*/
                    switch ($info_gral_car_des_otr_cor[$i]["PLAZA_ID"]) {
                      case 3:
                        $descargas_proceso_cor[$i] = $i;
                        break;
                      case 4:
                        $descargas_proceso_mex[$i] = $i;
                        break;
                      case 5:
                        $descargas_proceso_gol[$i] = $i;
                        break;
                      case 6:
                        $descargas_proceso_pen[$i] = $i;
                        break;
                      case 7:
                        $descargas_proceso_pue[$i] = $i;
                        break;
                      case 8:
                        $descargas_proceso_baj[$i] = $i;
                        break;
                      case 17:
                        $descargas_proceso_occ[$i] = $i;
                        break;
                      case 18:
                        $descargas_proceso_nor[$i] = $i;
                        break;
                      case 23:
                        $descargas_proceso_leo[$i] = $i;
                        break;
                    }
                    /*--TERMINA CREACION DE VARIABLES PARA DESCARGAS EN PROCESO EN CADA PLAZA--*/
                    break;
                  case 5:
                    echo '<td class="small text-green">'.$info_gral_car_des_otr_cor[$i]["STATUS"].'</td>';
                    /*--INICIA CREACION DE VARIABLES PARA DESCARGAS FINALIZADAS EN CADA PLAZA--*/
                    switch ($info_gral_car_des_otr_cor[$i]["PLAZA_ID"]) {
                      case 3:
                        $descargas_finalizadas_cor[$i] = $i;
                        break;
                      case 4:
                        $descargas_finalizadas_mex[$i] = $i;
                        break;
                      case 5:
                        $descargas_finalizadas_gol[$i] = $i;
                        break;
                      case 6:
                        $descargas_finalizadas_pen[$i] = $i;
                        break;
                      case 7:
                        $descargas_finalizadas_pue[$i] = $i;
                        break;
                      case 8:
                        $descargas_finalizadas_baj[$i] = $i;
                        break;
                      case 17:
                        $descargas_finalizadas_occ[$i] = $i;
                        break;
                      case 18:
                        $descargas_finalizadas_nor[$i] = $i;
                        break;
                      case 23:
                        $descargas_finalizadas_leo[$i] = $i;
                        break;
                    }
                    /*--TERMINA CREACION DE VARIABLES PARA DESCARGAS FINALIZADAS EN CADA PLAZA--*/
                    break;
                  case 6:
                    echo '<td class="small text-red">'.$info_gral_car_des_otr_cor[$i]["STATUS"].'</td>';
                    $descargas_canceladas_cor[$i] = $i;
                    break;
                }
              ?>
                  <td class="small"><span class="badge bg-blue"><?= $info_gral_car_des_otr_cor[$i]["ANDEN"] ?></span></td>
                  ...
                  <input type="hidden" name="plaza_manufac" value="<?=$info_gral_car_des_otr_cor[$i]["PLAZA"]?>">
                  <div id="cargando_img_cargas<?=$info_gral_car_des_otr_cor[$i]["SOLICITUD"]?>">
                  <button type="submit" class="btn btn-sm badge bg-blue click_cargando_cargas<?=$info_gral_car_des_otr_cor[$i]["SOLICITUD"]?>"><i class="fa fa-search"></i> VER</button></div>
                  <div id="cargando_text_cargas<?=$info_gral_car_des_otr_cor[$i]["SOLICITUD"]?>"></div>
                  </form>
                  </td>
                </tr>
  ...
  <!-- *************** TERMINA TABLA DE INFO GENERAL DESCARGAS *************** -->
  <!-- *************** INICIA TABLA DE INFO GENERAL OTROS *************** -->
    <div class="col-md-6">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"></h3>
        ...
        <div class="box-body"><!--box-body-->
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="box-footer no-padding"><br>
            <table id="tabla_alm_otros" class="table display compact table-striped table-hover" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th class="small">ALMACEN</th>
                  <th class="small">PLAZA</th>
                  <th class="small">OP</th>
                  <th class="small">STATUS</th>
                  <th class="small">CLIENTE</th>
                  <th class="small">TIEMPO</th>
                  <th class="small">INFO</th>
              ...
              for ($i=0; $i <count($info_gral_car_des_otr_cor) ; $i++) {
                ...
                //--  --//
                switch (true) {
                case ( $info_gral_car_des_otr_cor[$i]["REGISTRADO"] == true ) && ( $info_gral_car_des_otr_cor[$i]["H_LLEGADA"] == false ):
                  $fechaFin_car_gen = strftime("%d-%m-%Y %H:%M:%S");
                   $calculo_tiempo = $obj_info_gral_manufactura->calculo_tiempo($info_gral_car_des_otr_cor[$i]["REGISTRADO"],$fechaFin_car_gen);
                  break;
                case ( $info_gral_car_des_otr_cor[$i]["H_LLEGADA"] == false ):
                ...
                //--  --//
                if ( $info_gral_car_des_otr_cor[$i]["TIPO_OP"] >=3 ){
              ?>
                <tr>
                  <td class="small"><?= $info_gral_car_des_otr_cor[$i]["ALMACEN"] ?></td>
                  <td class="small"><?= $info_gral_car_des_otr_cor[$i]["PLAZA_SIG"] ?></td>
                 <?php
                  //-- DESCRIBE TIPO DE OPERACION EN OTROS --//
                  switch ($info_gral_car_des_otr_cor[$i]["TIPO_OP"]) {
                    case 3:
                       echo '<td class="small">CROSS DOCK</td>';
                      break;
                    case 4:
                       echo '<td class="small">ETIQUETADO</td>';
                      break;
                    case 5:
                       echo '<td class="small">MARBETEO</td>';
                      break;
                    case 6:
                       echo '<td class="small">OTROS</td>';
                      break;
                  }
                  ?>
                  <?php
                    if ($info_gral_car_des_otr_cor[$i]["ID_STATUS"] == 5 ){
                    echo '<td class="small text-red">'.$info_gral_car_des_otr_cor[$i]["STATUS"].'</td>';
                    }else{
                    echo '<td class="small text-blue">'.$info_gral_car_des_otr_cor[$i]["STATUS"].'</td>';
                    /*--INICIA CREACION DE VARIABLES PARA OTROS EN CADA PLAZA--*/
                    switch ($info_gral_car_des_otr_cor[$i]["PLAZA_ID"]) {
                      case 3:
                        $otros_cor[$i] = $i;
                        break;
                    ...
                    /*--TERMINA CREACION DE VARIABLES PARA OTROS EN CADA PLAZA--*/
                    }
                  ?>
                  <td class="small"><?= $info_gral_car_des_otr_cor[$i]["CLIENTE"] ?></td>
  ...
  <!-- *************** TERMINA TABLA DE INFO GENERAL OTROS *************** -->
  <!-- *************** INICIA TABLA DE INFO GENERAL CARGAS-DESCARGAS DESFASADO *************** -->
    <div class="col-md-6">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"></h3>
        ...
        <div class="box-body"><!--box-body-->
          ...
          <div class="box box-widget widget-user-2">
            <div class="small-box bg-red">
              <div class="inner">
                <p>Cargas-Descargas Finalizado Desfasado</p>
              </div>
              <div style="font-size:50px;" class="icon">
                <img  src="../dist/img/ser_dierectos.png" >
              </div>
            ...
            <div class="box-footer no-padding"><br>
            <table id="tabla_alm_des" class="table display compact table-striped table-hover" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th class="small">ALMACEN</th>
                  <th class="small">PLAZA</th>
              ...
              for ($i=0; $i <count($info_gral_car_des_otr_cor) ; $i++) {
                ...
                //--  --//
                if ( $info_gral_car_des_otr_cor[$i]["TIPO_OP"] <3 ){
                  if ( $calculo_minutos > 90 && $info_gral_car_des_otr_cor[$i]["ID_STATUS"] == 5 ){
              ?>
                <tr>
                  <td class="small"><?= $info_gral_car_des_otr_cor[$i]["ALMACEN"] ?></td>
                  <td class="small"><?= $info_gral_car_des_otr_cor[$i]["PLAZA_SIG"] ?></td>
              <?php
              //-- DESCRIBE TIPO DE OPERACION CARGA-DESCARGA --//
              switch ($info_gral_car_des_otr_cor[$i]["TIPO_OP"]) {
                case 1:
                   echo '<td class="small text-aqua">CARGA</td>';
                   /*--INICIA CREACION DE VARIABLES PARA CARGAS FINALIZADAS DESFASADAS EN CADA PLAZA--*/
                    switch ($info_gral_car_des_otr_cor[$i]["PLAZA_ID"]) {
                      case 3:
                        $cargas_finalizadas_des_cor[$i] = $i;
                        break;
                      case 4:
                        $cargas_finalizadas_des_mex[$i] = $i;
                        break;
                      case 5:
                        $cargas_finalizadas_des_gol[$i] = $i;
                        break;
                      case 6:
                        $cargas_finalizadas_des_pen[$i] = $i;
                        break;
                      case 7:
                        $cargas_finalizadas_des_pue[$i] = $i;
                        break;
                      case 8:
                        $cargas_finalizadas_des_baj[$i] = $i;
                        break;
                      case 17:
                        $cargas_finalizadas_des_occ[$i] = $i;
                        break;
                      case 18:
                        $cargas_finalizadas_des_nor[$i] = $i;
                        break;
                      case 23:
                        $cargas_finalizadas_des_leo[$i] = $i;
                        break;
                    }
                    /*--TERMINA CREACION DE VARIABLES PARA CARGAS FINALIZADAS DESFASADAS EN CADA PLAZA--*/
                  break;
                case 2:
                   echo '<td class="small text-green">DESCARGA</td>';
                   /*--INICIA CREACION DE VARIABLES PARA DESCARGAS FINALIZADAS DESFASADAS EN CADA PLAZA--*/
                    switch ($info_gral_car_des_otr_cor[$i]["PLAZA_ID"]) {
                      case 3:
                        $descargas_finalizadas_des_cor[$i] = $i;
                        break;
                      case 4:
                        $descargas_finalizadas_des_mex[$i] = $i;
                        break;
                      case 5:
                        $descargas_finalizadas_des_gol[$i] = $i;
                        break;
                      case 6:
                        $descargas_finalizadas_des_pen[$i] = $i;
                        break;
                      case 7:
                        $descargas_finalizadas_des_pue[$i] = $i;
                        break;
                      case 8:
                        $descargas_finalizadas_des_baj[$i] = $i;
                        break;
                      case 17:
                        $descargas_finalizadas_des_occ[$i] = $i;
                        break;
                      case 18:
                        $descargas_finalizadas_des_nor[$i] = $i;
                        break;
                      case 23:
                        $descargas_finalizadas_des_leo[$i] = $i;
                        break;
                    }
                    /*--TERMINA CREACION DE VARIABLES PARA DESCARGAS FINALIZADAS DESFASADAS EN CADA PLAZA--*/
                  break;
              }
              ?>
                  <td class="small"><?= $info_gral_car_des_otr_cor[$i]["STATUS"] ?></td>
                  <td class="small"><span class="badge bg-blue"><?= $info_gral_car_des_otr_cor[$i]["ANDEN"] ?></span></td>
                  <td class="small"><?= $info_gral_car_des_otr_cor[$i]["CLIENTE"] ?></td>
                  <td class="small"><?= $calculo_tiempo ?></td>
                  <td class="small">
  ...
  <!-- *************** TERMINA TABLA DE INFO GENERAL CARGAS-DESCARGAS DESFASADO *************** -->
...
<!-- ######### INICIA SECCION PARA LAS GRAFICAS EN CARGAS ########## -->
<section>
  <div class="row">
    ...
    <div class="col-md-7">
      <div class="box box-info">
        ...
        <div class="box-body"><!--box-body-->
          ...
          <div id="bar-chart-cargas" style="height: 340px; "></div>
  ...
  <!-- ######### INICIA SECCION PARA GRAFICA DE DONA EN CARGAS EFECTIVIDAD ########## -->
    <div class="col-md-5">
      <div class="box box-info">
        ...
        <div class="box-body"><!--box-body-->
          <h4 class="content-header text-blue text-center"><i class="fa fa-pie-chart"></i> Efectividad en Cargas</h4>
          <div id="donut-chart-car-efec" style="height: 285px; "></div>
        </div><!--/.box-body-->
      </div>
    </div>
  <!-- ######### TERMINA SECCION PARA GRAFICA DE DONA EN CARGAS EFECTIVIDAD ########## -->


  </div>
</section>
<!-- ######### TERMINA SECCION PARA LAS GRAFICAS EN CARGAS ########## -->
    ...
    <div class="box-body"><!--box-body-->
      ...
      <div class="nav-tabs-custom"><!-- nav-tabs-custom -->
        ...
        <!-- TAB PARA CARGAS EN PROCESO -->
          ...
          <h5 class="text-blue text-center"><i class="fa fa-spin fa-hourglass-half"></i> CARGAS EN PROCESO <?= $plaza_manufac." <code>". $titulo_fec_manufac."</code>" ?> </h5><hr>
            ...
            <?php
              switch ($plaza_manufac) {
                case "BAJIO (ARGO)":
                  ...
                  break;
                default:
                  echo "<a class='fancybox fancybox.iframe' href='manufactura_det_retarr.php?almacen=".$info_manufac_car_des[$i]["ALMACEN_ID"]."&retarr=".$info_manufac_car_des[$i]["SOLICITUD"]."'><span class='badge bg-teal btn'><i class='fa fa-folder-open'></i> Detalles Solicitud: <cite>".$info_manufac_car_des[$i]["SOLICITUD"]."</cite></span></a>";
                  break;
              }
            ?>
            ...
            <div class="table-responsive">
              ...
              <thead>
                <tr>
                  ...
                  <th class="small">DETALLES #ARR-RET</th>
                </tr>
              </thead>
              <tbody>
              <?php
                ...
                //--  --//
                if ( $info_manufac_car_des[$i]["TIPO"] == 1 && $info_manufac_car_des[$i]["STATUS"] == 5 && $calculo_minutos <90 ){
              ...
              ?>
                <tr>
                  ...
                  <?php
                    switch ($plaza_manufac) {
                      case "BAJIO (ARGO)":
                        echo "<a class='fancybox fancybox.iframe' href='manufactura_det_retarr.php?almacen=".$info_manufac_car_des[$i]["ALMACEN_ID"]."&retarr=".$info_manufac_car_des[$i]["ARRIBO"]."'>
...
<!-- ######### TERMINA SECCION TABLA CARGAS INFO ########## -->


<!-- ############################ TERMINA SECCION PARA CARGAS ############################# -->


<!-- ############################ INICIA SECCION PARA DESCARGAS ############################# -->


<!-- ######### INICIA SECCION PARA LAS GRAFICAS EN DESCARGAS ########## -->
<section>
  <div class="row">
    ...
    <div class="col-md-7">
      <div class="box box-success">
        ...
        <div class="box-body"><!--box-body-->
          ...
          <div id="bar-chart-descargas" style="height: 340px; "></div>
  ...
  <!-- ######### INICIA SECCION PARA GRAFICA DE DONA EN DESCARGAS EFECTIVIDAD ########## -->
    <div class="col-md-5">
      <div class="box box-success">
        ...
        <div class="box-body"><!--box-body-->
        <h4 class="content-header text-blue text-center"><i class="fa fa-pie-chart"></i> Efectividad en Descargas</h4>
          <div id="donut-chart-des-efec" style="height: 285px; "></div>
        </div><!--/.box-body-->
      </div>
    </div>
  <!-- ######### TERMINA SECCION PARA GRAFICA DE DONA EN DESCARGAS EFECTIVIDAD ########## -->


  </div>
</section>
<!-- ######### TERMINA SECCION PARA LAS GRAFICAS EN DESCARGAS ########## -->
    ...
    <div class="box-body"><!--box-body-->
      ...
      <div class="nav-tabs-custom"><!-- nav-tabs-custom -->
        ...
        <!-- TAB PARA DESCARGAS EN PROCESO -->
          ...
          <h5 class="text-blue text-center"><i class="fa fa-spin fa-hourglass-half"></i> DESCARGAS EN PROCESO <?= $plaza_manufac." <code>". $titulo_fec_manufac."</code>" ?> </h5><hr>
      ...
      ?>
        <tr><!-- INICIA TR DESCARGAS EN PROCESO -->
          <td colspan="7"><!-- INICIA TD DESCARGAS EN PROCESO -->
            ...
            <span class="badge bg-teal btn"><i class="fa fa-folder-open"></i> Detalles Arribo: <cite><?= $info_manufac_car_des[$i]["ARRIBO"] ?></cite></span>
            </a>
            <br> <br> <br>
            ...
            <div class="table-responsive">
              ...
              <thead>
                <tr>
                  ...
                  <th class="small">CANTIDAD</th>
                  <th class="small">ALMACENISTA</th>
                  <th class="small">DETALLES #ARRIBO</th>
                </tr>
              </thead>
              <tbody>
              <?php
                ...
                //--  --//
                if ( $info_manufac_car_des[$i]["TIPO"] == 2 && $info_manufac_car_des[$i]["STATUS"] == 5 && $calculo_minutos <90 ){
...
<section style="display:none">
   <div class="box box-warning">
    <div class="box-header with-border">
      <h3 class="box-title">GRAFICA OP OTROS (CROSS DOCK-ETIQUETADO-MARBETADO-OTROS)</h3>
      <div class="box-tools pull-right">
        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
      </div>
    </div>
    <div class="box-body"><!--box-body-->
       ...
       <div id="bar-chart-otros" style="height: 300px; "></div>
    ...
    <div class="box-header with-border">
      <p class="box-card">
        <ul class="nav nav-tabs" id="myTab_manufac_otros">
          <li class="active"><a id="tab_otr_pen" data-toggle="tab" href="#link_tab_otr_pen">Pendientes</a></li>
          <li><a id="tab_otr_pro" data-toggle="tab" href="#link_tab_otr_pro">EnProceso</a></li>
          <li><a id="tab_otr_con" data-toggle="tab" href="#link_tab_otr_con">Concluidos</a></li>
          <li><a id="tab_otr_can" data-toggle="tab" href="#link_tab_otr_can">Cancelado</a></li>
        </ul>
      </p>
      <div class="box-tools pull-right">
        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
    ...
    <div class="box-body"><!--box-body-->
       ...
       <div class="nav-tabs-custom"><!-- nav-tabs-custom -->
        <div class="tab-content"><!-- tab-content -->
          ...
          <div id="link_tab_otr_pen" class="tab-pane fade in active">

            <h5 class="text-yellow text-center"><i class="fa fa-spin fa-spinner"></i> OPERACIONES OTROS PENDIENTES <?= $plaza_manufac." <code>". $titulo_fec_manufac."</code>" ?> </h5><hr>

            <!-- INICIA TABLA PARA OTROS PENDIENTES -->
              <div class="table-responsive">
                <table id="tabla_manufac_car_can" class="table compact table-hover table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    ...
                    <th class="small">Tiempo Trascurrido</th>
                    <th class="small">STATUS</th>
                    <th class="small">OBS.</th>
                    <th class="small">T/VEHÍCULO</th>
                    <th class="small">PLACAS</th>
                ...
                <tbody>
                <?php
                $otros_info = $obj_info_otros_manufac->otros_info($plaza_manufac,$dia_manufac,$fec_ini_per_manufac,$fec_fin_per_manufac);
                for ($i=0; $i <count($otros_info) ; $i++) {
                  if( $otros_info[$i]["STATUS"]== 1 ){
                  $otros_pendientes[$i] = $i;
                ?>
                  <tr>
                    ...
                    <td class="small"><span class="badge bg-info"><i class="fa  fa-clock-o"></i> <?= $otros_info[$i]["F_PENDIENTE"] ?></span></td>
                    <!-- INICIA CALCULO DE TIEMPO EN OTROS -->
                    <?php
                    switch (true) {
                      case ($otros_info[$i]["F_PENDIENTE"] == false):
                        $calculo_tiempo_otros = "<code>No se Registro Tiempo</code>";
                        break;

                      default:
                        $fechaInicio = $otros_info[$i]["F_PENDIENTE"];
                        $fechaFin = strftime("%d-%m-%Y %H:%M:%S");
                        $calculo_tiempo_otros = $obj_op_in_car_des_info->calculo_tiempo($fechaInicio,$fechaFin);
                        break;
                    }
                    ?>
                    <td class="small"><code> <?=$calculo_tiempo_otros?> </code></td>
                    <!-- TERMINA CALCULO DE TIEMPO EN OTROS -->
                    <td class="small"><span class="badge bg-orange">PENDIENTE</span></td>
                    <td class="small"><?= $otros_info[$i]["OBS_PEN"] ?></td>
            ...
            <!-- TERMINA TABLA PARA OTROS PENDIENTES -->
          </div>
          <!-- TAB OTROS EN PROCESO -->
          <div id="link_tab_otr_pro" class="tab-pane fade">

          <h5 class="text-teal text-center"><i class="fa fa-spin fa-refresh"></i> OPERACIONES OTROS EN PROCESO <?= $plaza_manufac." <code>". $titulo_fec_manufac."</code>" ?> </h5><hr>

            <!-- INICIA TABLA PARA OTROS EN PROCESO -->
              <div class="table-responsive">
                <table id="tabla_manufac_car_can" class="table compact table-hover table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                  <tr>
                ...
                <?php
                for ($i=0; $i <count($otros_info) ; $i++) {
                  if( $otros_info[$i]["STATUS"]== 2 || $otros_info[$i]["STATUS"]== 3 ){
                  $otros_proceso[$i] = $i;
                ?>
                  <tr>
                    <td class="small"><?= $otros_info[$i]["ALMACEN"] ?></td>
                    ...
                    <!-- INICIA CALCULO DE TIEMPO EN OTROS -->
                    <?php
                    switch ($otros_info[$i]["STATUS"]) {
                      case 2:
                        $status_otr_iniproc = "INICIO";
                        $obs_otros_iniproc = $otros_info[$i]["OBS_INI"];
                        if ($otros_info[$i]["F_INICIO"] == false){
                           $fechaInicio = $otros_info[$i]["F_INICIO"];
                           $calculo_tiempo_otros = "<code>No se Registro Tiempo</code>";
                        }else{
                          $fechaInicio = $otros_info[$i]["F_INICIO"];
                          $fechaFin = strftime("%d-%m-%Y %H:%M:%S");
                        ...
                        break;
                      case 3:
                        $status_otr_iniproc = "EN PROCESO";
                        $obs_otros_iniproc = $otros_info[$i]["OBS_PRO"];
                        if ($otros_info[$i]["F_PROCESO"] == false){
                           $fechaInicio = $otros_info[$i]["F_PROCESO"];
                           $calculo_tiempo_otros = "<code>No se Registro Tiempo</code>";
                        }else{
                          $fechaInicio = $otros_info[$i]["F_PROCESO"];
                          $fechaFin = strftime("%d-%m-%Y %H:%M:%S");
                    ...
                    ?>
                    <td class="small"><span class="badge bg-info"><i class="fa  fa-clock-o"></i> <?= $fechaInicio ?></span></td>
                    <td class="small"><code> <?=$calculo_tiempo_otros?> </code></td>
                    <!-- TERMINA CALCULO DE TIEMPO EN OTROS -->
                    <td class="small"><span class="badge bg-teal"><?=$status_otr_iniproc?></span></td>
                    <td class="small"><?= $obs_otros_iniproc ?></td>
                    <td class="small"><?= $otros_info[$i]["VEHICULO"] ?></td>
                    <td class="small"><?= $otros_info[$i]["PLACAS"] ?></td>
                    <td class="small"><?= $otros_info[$i]["UME"] ?></td>
                    <td class="small"><?= $otros_info[$i]["CANTIDAD"] ?></td>
            ...
            <!-- TERMINA TABLA PARA OTROS EN PROCESO -->
          </div>
          <!-- TAB OTROS CONCLUIDOS -->
          <div id="link_tab_otr_con" class="tab-pane fade">

          <h5 class="text-green text-center"><i class="fa fa-check-square-o"></i> OPERACIONES OTROS CONCLUIDOS <?= $plaza_manufac." <code>". $titulo_fec_manufac."</code>" ?> </h5><hr>
            ...
            <!-- INICIA TABLA PARA OTROS CONCLUIDOS -->
              <div class="table-responsive">
                ...
                <?php
                for ($i=0; $i <count($otros_info) ; $i++) {
                  if( $otros_info[$i]["STATUS"]== 4 ){
                  $otros_concluidos[$i] = $i;
                ?>
                  <tr>
                    <td class="small"><?= $otros_info[$i]["ALMACEN"] ?></td>
                    <td class="small"><code><?= $otros_info[$i]["SOLICITUD"] ?></code></td>
                    <td class="small"><?= $otros_info[$i]["OPERACION"] ?></td>
                    <td class="small"><?= $otros_info[$i]["RS_CLI"] ?></td>
                    <td class="small"><span class="badge bg-info"><i class="fa  fa-clock-o"></i> <?= $otros_info[$i]["INICIO"] ?></span></td>
                    <td class="small"><span class="badge bg-info"><i class="fa  fa-clock-o"></i> <?= $otros_info[$i]["TERMINO"] ?></span></td>
                    <!-- INICIA CALCULO DE TIEMPO EN OTROS -->
                    <?php
                    switch (true) {
                      case ($otros_info[$i]["INICIO"] == false):
                        $calculo_tiempo_otros = "<code>No se Registro Tiempo</code>";
                        break;

                      default:
                        $fechaInicio = $otros_info[$i]["INICIO"];
                        $fechaFin = $otros_info[$i]["TERMINO"];
                        $calculo_tiempo_otros = $obj_op_in_car_des_info->calculo_tiempo($fechaInicio,$fechaFin);
                        break;
                    }
                    ?>
          ...
          <h5 class="text-red text-center"><i class="fa fa-ban"></i> OPERACIONES OTROS CANCELADOS <?= $plaza_manufac." <code>". $titulo_fec_manufac."</code>" ?> </h5><hr>
...
// OP MANUFACTURA OTROS
    /*TAB OTROS PENDIENTES*/
    $('#tab_otr_pen,#tab_otr_pen').on('shown.bs.tab', function (e) {
...
$(document).ready(function() {
  ...
  var button_view = {
    ...
    $('#tabla_manufac_car_tiem,#tabla_manufac_car_des,#tabla_manufac_car_can').DataTable({
      stateSave: true,
      "ordering": true,
...
//VARIABLE PARA GRAFICA DE BARRAS OPERACIONES OTROS
  var v_data_otros= [
    { data: [['<a id="tab_otr_pen" data-toggle="tab" href="#link_tab_otr_pen">Pendientes</a>', <?=$total_otros_pendientes?> ]],
      color: '#F39C12', },

    { data: [['<a id="tab_otr_pro" data-toggle="tab" href="#link_tab_otr_pro">EnProceso</a>', <?=$total_otros_proceso?> ]],
      color: '#39CCCC'},

    { data: [['<a id="tab_otr_con" data-toggle="tab" href="#link_tab_otr_con">Concluidos</a>', <?=$total_otros_concluidos?> ]],
      color: '#555299'},

    { data: [['<a id="tab_otr_can" data-toggle="tab" href="#link_tab_otr_can">Cancelado</a>', <?=$total_otros_cancelados?> ]],
      color: '#DD4B39'}
    ];
...
/*------------- GRAFICA GENERAL-------------------------*/
<?php if ($plaza_manufac == false){?>
  $.plot($("#bar-chart-global"), data1,option_graf_global);
  $(".flot-tick-label").css("zIndex","2");
<?php } ?>

<?php if ($plaza_manufac == true){?>
/*------------- GRAFICA CARGAS-------------------------*/
  $.plot("#bar-chart-cargas", v_data_cargas, v_option_bar_carga);
/*------------- GRAFICA DESCARGAS-------------------------*/
  $.plot("#bar-chart-descargas", v_data_descargas, v_option_bar_carga);
/*------------- GRAFICA EFECTIVIDAD CARGAS-------------------------*/
  $.plot("#donut-chart-car-efec", donutData_efec_car, option_donut_efec);
/*------------- GRAFICA EFECTIVIDAD DESCARGAS-------------------------*/
  $.plot("#donut-chart-des-efec", donutData_efec_des, option_donut_efec);
/*------------- GRAFICA OTROA-------------------------*/
  $.plot("#bar-chart-otros", v_data_otros, v_option_bar_carga);
