            ...
            <div class="col-lg-6">
              ...
              <div class="input-group">
                <div class="checkbox">
                  ...
                  <label>
                    <input type="checkbox" id="checkbox_visual2" <?php if($op_visual[1]==true){echo "checked";}?> >Comparativo
                  </label>
                  <label>
                    <input type="checkbox" id="checkbox_visual3" <?php if($op_visual[2]==true){echo "checked";}?> >Acumulado
                  </label>
                </div>
              </div>
            </div>
      ...
      <table id="tabla_lista" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">
        ...
        ?>
          <tr>
            ...
            <td class="small"><?php $diferencia_com_mes = array_sum($saldo_mes) - array_sum($saldo_mes_anterior);
            ...
            <?php } ?>
            <td class="small"><?php $diferencia_diferencia = array_sum($saldo_diferencia_anio) - array_sum($saldo_diferencia_anio_anterior);
