...
{
  header("location:cartas_cupo_anuales_crossdock.php");
  //return;
}
session_start();
...
$modulos_valida = Perfil::modulos_valida($_SESSION['iid_empleado'], 39);
if($modulos_valida == 0)
{
  header('Location: index.php');
}
///////////////////////////////////////////
include '../class/Cartas_Cupo_Anuales_CrossDock.php';
...
$graficaMensualWidgets = $modelNomina->grafica_Widgets_Mensual($fecha,$plaza);
$grafica_Widgets_Value = $modelNomina->grafica_Widgets_Value($fecha,$plaza);
...
<div class="content-wrapper"><!-- Inicia etiqueta content-wrapper principal -->
  <section class="content-header">
    <h1>Dashboard<small>Cartas Cupo Cross-Dock</small></h1>
  </section>
  <section>
    <div  class="col-md-12">
    <div class="row">
          ...
          <span class="info-box-icon bg-aqua"><i class="fa fa-edit"></i></span>
            <div class="info-box-content bg-aqua">
              <span class="info-box-number">
                <?php
                  echo '<h3>'.($graficaMensualWidgets[0]["CCE_ANIO1"]).'</h3>';
                  echo '<h5>$'.number_format($grafica_Widgets_Value[0]["VALUE_CARTAS"], 2).'</h5>';
                ?>
              </span>
              <span class="progress-description"><b>C.C. ARRIBADAS <br> (CROSSDOCK) </b></span>
            </div>
        </div>
      </div>
    </div>
  ...
  <section>
    ...
    <div class="box box-info">
      <div class="box-header with-border">
        ...
        <a href="cartas_cupo_anuales_crossdock.php"><button class="btn btn-sm btn-warning">Borrar Filtros <i class="fa fa-close"></i></button></a>
        <?php } ?>
        <div class="box-tools pull-right">
          <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
        </div>
  ...
  <section>
    <div class="box box-success">
      <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-table"></i> Cartas Cupo Arribadas (Cross-Dock) Por Mes</h3>
        <div class="box-tools pull-right">
          <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
...
$(function () {
  ...
  $('#graficaNom').highcharts({
    chart: { type: 'column' },
    title: { text: 'Comparativo Cartas Cupo Arribadas (Cross-Dock) Por Plaza' },
    legend:{
            y: -40,
            borderWidth: 1,
...
<script type="text/javascript">
  $(function(){
    ...
    $('#graficaMensual').highcharts({
      chart:{type: 'line'},
      title:{text: 'Comparativo Cartas Cupo Arribadas (Cross-Dock) Por Mes <?php if($plaza == 'ALL'){echo "";} else {echo $plaza;}?>'},
      legend:{
        y:-40,
        borderWidth:1,
        backgroundColor: (Highcharts.theme && Highcharts.theme.legendBackgroundColor) || '#c6c2c2'
      ...
      tooltip:{
        shared:true,
        valueSuffix:' CARTAS CUPO CROSSDOCK',
        useHTML:true,
        valueDecimals:0,
        valuePrefix:'',
      },
