...
$modulos_valida = Perfil::modulos_valida($_SESSION['iid_empleado'], '44');
if($modulos_valida == 0)
{
  header('Location: index.php');
}
/* .-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- INICIA CODE INDEPENDIENTE .-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-  */
include_once '../class/InformacionClientesPresupuesto.php';
$insObj_VentaPromotor = new VentaAlmacen();
/*declaracion de sessiones*/
/* var presupuesto */
$pre = 3;
if ( isset($_GET["pre"]) ){
	if ( $_GET["pre"] == 1 || $_GET["pre"] == 3 ){
		$pre = $_GET["pre"];
	}
}
/* var año */
...
if (isset($_GET["almacen"])) {
  if ($promotor != "ALL" || $pre == 3) {
    $validaAlm = $insObj_VentaPromotor->sql(" SELECT COUNT(*) valida FROM Almacen a WHERE a.iid_almacen = ".(int)$_GET["almacen"]." " );
    if ($validaAlm[0]["VALIDA"] > 0 ){ $almacen = $_GET["almacen"];}
  }
}
...
if (isset($_GET["cliente"])) {
  if ($promotor != "ALL" || $pre == 3) {
    $validaCli = $insObj_VentaPromotor->sql(" SELECT COUNT(*) valida FROM CLIENTE C WHERE  C.IID_NUM_CLIENTE =  ".(int)$_GET["cliente"]." " );
    if ($validaCli[0]["VALIDA"] > 0 ){ $cliente = $_GET["cliente"];}
  }
}
...
$consulta_por_cliente = $insObj_VentaPromotor->informacionAnualCliente($fecha,$promotor,$plaza,$almacen,$cliente);
$consulta_por_cliente2 = $insObj_VentaPromotor->informacionAnualCliente2($fecha-1,$promotor,$plaza,$almacen,$cliente);
...
<!-- ########################################## Incia Contenido de la pagina ########################################## -->
 <div class="content-wrapper"><!-- Inicia etiqueta content-wrapper principal -->
    ...
    <section class="content-header">
      <h1>Dashboard <small>Facturación</small></h1>
    </section>
    <!-- Main content -->
      ...
      <div class="box box-warning">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-line-chart"></i> Facturación:</span>
            <select class="form-control select2" id="selectPre">
              <option value="3" <?php if( $pre == 3 ){ echo "selected"; } ?> >PLAZA</option>
            </select>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-sitemap"></i> Almacen:</span>
            <select class="form-control select2" id="selectAlmacen"></select>
          </div>
        </div>

        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-sitemap"></i> Cliente:</span>
            <select class="form-control select2" id="selectCliente"></select>
          </div>
        </div>
    ...
    <section>
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title" id="nomTabla2"><i class="fa fa-line-chart"></i> DISTRIBUCIÓN DE FACTURACION <?=$fecha?> <?php if($pre == 3){echo "PLAZAS";}else{echo "PROMOTORES";} ?> </h3>
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
          </div>
        ...
        <div class="box-body"><!--box-body-->
          ...
          <div class="table-responsive loadInfoPre">
            <table id="tablaInfoPre2" class="display table table-bordered table-hover table-striped" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th class="small" bgcolor="#0073B7"><font color="white">CLIENTE</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">ENERO</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">FEBRERO</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">MARZO</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">ABRIL</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">MAYO</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">JUNIO</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">JULIO</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">AGOSTO</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">SEPTIEMBRE</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">OCTUBRE</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">NOVIEMBRE</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">DICIEMBRE</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">TOTAL</th>
                </tr>
              </thead>
              <tbody>
                <?php for ($i=0; $i <count($consulta_por_cliente) ; $i++) { ?>
                  <?php if (is_null($consulta_por_cliente[$i]["CLIENTE"])){ ?>

                  <?php }else{ ?>
                <tr>
                      <td><?= $consulta_por_cliente[$i]["CLIENTE"] ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Ene'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Feb'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Mar'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Abr'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'May'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Jun'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Jul'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Ago'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Sep'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Oct'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Nov'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Dic'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente[$i]["'Ene'"] +
                                            $consulta_por_cliente[$i]["'Feb'"] +
                                            $consulta_por_cliente[$i]["'Mar'"] +
                                            $consulta_por_cliente[$i]["'Abr'"] +
                                            $consulta_por_cliente[$i]["'May'"] +
                                            $consulta_por_cliente[$i]["'Jun'"] +
                                            $consulta_por_cliente[$i]["'Jul'"] +
                                            $consulta_por_cliente[$i]["'Ago'"] +
                                            $consulta_por_cliente[$i]["'Sep'"] +
                                            $consulta_por_cliente[$i]["'Oct'"] +
                                            $consulta_por_cliente[$i]["'Nov'"] +
                                            $consulta_por_cliente[$i]["'Dic'"], 2) ?></td>
                </tr>
                  <?php } ?>
                <?php } ?>
              </tbody>
    ...
    <!-----------------------------------------------FACTURACION AÑO ANTERIOR ------------------------------------->
    <section>
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title" id="nomTabla2"><i class="fa fa-line-chart"></i> DISTRIBUCIÓN DE FACTURACION <?=$fecha-1?> <?php if($pre == 3){echo "PLAZAS";}else{echo "PROMOTORES";} ?> </h3>
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
          </div>
        ...
        <div class="box-body"><!--box-body-->
          ...
          <style type="text/css"> #tablaInfoPre tr { cursor: pointer; } </style>
          <div class="table-responsive loadInfoPre">
            <table id="tablaInfoPre3" class="display table table-bordered table-hover table-striped" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th class="small" bgcolor="#0073B7"><font color="white">CLIENTE</th>
                  <th class="small" bgcolor="#0073B7"><font color="white">ENERO</th>
              ...
              <tbody>
                <?php for ($i=0; $i <count($consulta_por_cliente2) ; $i++) { ?>
                  <?php if (is_null($consulta_por_cliente2[$i]["CLIENTE"])){ ?>

                  <?php }else{ ?>
                <tr>
                      <td><?= $consulta_por_cliente2[$i]["CLIENTE"] ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Ene'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Feb'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Mar'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Abr'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'May'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Jun'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Jul'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Ago'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Sep'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Oct'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Nov'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Dic'"], 2) ?></td>
                      <td><?= number_format($consulta_por_cliente2[$i]["'Ene'"] +
                                            $consulta_por_cliente2[$i]["'Feb'"] +
                                            $consulta_por_cliente2[$i]["'Mar'"] +
                                            $consulta_por_cliente2[$i]["'Abr'"] +
                                            $consulta_por_cliente2[$i]["'May'"] +
                                            $consulta_por_cliente2[$i]["'Jun'"] +
                                            $consulta_por_cliente2[$i]["'Jul'"] +
                                            $consulta_por_cliente2[$i]["'Ago'"] +
                                            $consulta_por_cliente2[$i]["'Sep'"] +
                                            $consulta_por_cliente2[$i]["'Oct'"] +
                                            $consulta_por_cliente2[$i]["'Nov'"] +
                                            $consulta_por_cliente2[$i]["'Dic'"], 2) ?></td>
                </tr>
                  <?php } ?>
                <?php } ?>
              </tbody>
    ...
    <section style="display:none">
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title" id="nomTabla2"><i class="fa fa-line-chart"></i> DISTRIBUCIÓN DE PRESUPUESTO <?=$fecha?> <?php if($pre == 3){echo "PLAZAS";}else{echo "PROMOTORES";} ?> </h3>
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
          </div>
        ...
        <div class="box-body"><!--box-body-->
          ...
          <div class="table-responsive loadInfoPre">
            <table id="tablaInfoPre" class="table table-bordered table-hover table-striped">
              <thead>
                <tr>
                  <th style="background-color: #6099B4; color:white;"><?php if($pre == 3){echo "PLAZA";}else{echo "PROMOTOR";} ?></th>
              ...
              <tfoot>
                <tr <?php if ($pre == 3){if($plaza == "ALL"){echo 'style="background-color: #C8E5EE;';}}else{if($promotor == "ALL"){echo 'style="background-color: #C8E5EE;';}} ?> data-info="ALL">
                  <th>TOTAL</th>
    ...
    <section style="display:none">
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title"> <?php if($pre == 3){echo '<i class="fa fa-sitemap"></i>';}else{echo '<i class="fa fa-user"></i>';} ?> PRESUPUESTO <?=$fecha?> VS RESULTADO <?=$fecha?> </h3>
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
          </div>
...
<script type="text/javascript">
$.ajax({url: '../action/venta_AlmacenAjax.php',
...
$.ajax( {
	type : "POST",
	url : "../action/venta_AlmacenAjax.php",
	cache: false,
	data : { "selectAnio": 1},
	beforeSend: function () {
...
$.ajax( {
  ...
  url : "../action/venta_AlmacenAjax.php",
  cache: false,
  data : { "selectPlaza": 3, 'fecha' : <?= $fecha ?>, 'pre' : <?= $pre ?> },
  beforeSend: function () {
...
$("#selectPlaza").on("change",function (){
  location.href = "<?=basename($_SERVER['PHP_SELF']).'?'?>pre=<?=$pre?>&fecha=<?=$fecha?>&promotor=<?=$promotor?>&almacen=<?=$almacen?>&cliente=<?=$cliente?>&plaza="+$(this).val();
});

<?php if ($plaza <> 'ALL') { ?>
  $("#selectAlmacen").on("change",function (){
    location.href = "<?=basename($_SERVER['PHP_SELF']).'?'?>pre=<?=$pre?>&fecha=<?=$fecha?>&promotor=<?=$promotor?>&cliente=<?=$cliente?>&plaza=<?=$plaza?>&cliente=<?=$cliente?>&almacen="+$(this).val();
  });
<?php } ?>

<?php if ($plaza <> 'ALL') { ?>
  $("#selectCliente").on("change",function (){
    location.href = "<?=basename($_SERVER['PHP_SELF']).'?'?>pre=<?=$pre?>&fecha=<?=$fecha?>&promotor=<?=$promotor?>&plaza=<?=$plaza?>&almacen=<?=$almacen?>&cliente="+$(this).val();
  });
<?php } ?>

<?php if ($plaza == 'ALL') { ?>
  $("#selectCliente").on("change",function (){
    location.href = "<?=basename($_SERVER['PHP_SELF']).'?'?>pre=<?=$pre?>&fecha=<?=$fecha?>&promotor=<?=$promotor?>&plaza=<?=$plaza?>&almacen=ALL&cliente="+$(this).val();
  });
<?php } ?>
...
function consultaAlmacen(){
  ...
  url : "../action/venta_AlmacenAjax.php",
  cache: false,
  data : {"selectAlmacen":3 , 'pre': <?= $pre ?> , 'plaza': '<?= $plaza ?>'},
  beforeSend: function(){
    var $selectalm = $('#selectAlmacen');
    $selectalm.append('<option>Procesando... </option>');
  },
  success: function(response){
    var dataJson = JSON.parse(response);
    var $selectalm = $('#selectAlmacen');
    $selectalm.empty();
    <?php  if ($plaza == "ALL" && $pre = 3) {?>
        $selectalm.append('<option value "ALL">Seleccione Plaza</option>');
    <?php }else{ ?>
      $selectalm.append('<option value = "ALL">ALL</option>');
      $.each(dataJson, function(i,val){
        $selectalm.append($("<option select></option>").attr('value', val.IID_ALMACEN).text("("+val.IID_ALMACEN+") "+val.V_NOMBRE));
        $selectalm.find('option[value="<?=$almacen?>"]').attr('selected', 'selected');
      });
  <?php } ?>
  }
});
...
function consultaCliente(){
  ...
  url : "../action/venta_AlmacenAjax.php",
  cache: false,
  data : {"selectCliente":3 , 'pre': <?= $pre ?> , 'plaza': '<?= $plaza ?>', 'almacen':'<?= $almacen ?>' },
  beforeSend: function(){
    var $selectalm = $('#selectCliente');
    $selectalm.append('<option>Procesando... </option>');
  },
  success: function(response){
    var dataJson = JSON.parse(response);
    ...
    <?php  if ($plaza == "ALL" && $pre = 3) {?>
      $selectalm.append('<option value = "ALL">ALL</option>');
      $.each(dataJson, function(i,val){
        $selectalm.append($("<option select></option>").attr('value', val.IID_CLIENTE).text("("+val.IID_CLIENTE+") "+val.RAZONSOCIAL));
        $selectalm.find('option[value="<?=$cliente?>"]').attr('selected', 'selected');
      });
    <?php }else{ ?>
      $selectalm.append('<option value = "ALL">ALL</option>');
      $.each(dataJson, function(i,val){
...
function wherePresupuesto(){
  $.ajax({
    ...
    url: "../action/venta_AlmacenAjax.php",
    cache : false,
    data : { "wherePresupuesto": 1, "v_pre" : <?=$pre?>, "v_fecha": <?=$fecha?>, "v_promotor" : "<?=$promotor?>", "v_plaza" : "<?=$plaza?>", "almacen" : "<?=$almacen?>" },
    success: function (response) {
      var dataJson = JSON.parse(response);
      var TotalWherePre = 0;
      $.each(dataJson, function( index, value ) {
...
function ventaReal(){
  ...
  $.ajax({
    ...
    url: "../action/venta_AlmacenAjax.php",
    cache : false,
    data : { "ventaReal": 1, "v_pre" : <?=$pre?>, "v_fecha": <?=$fecha?>, "v_promotor" : "<?=$promotor?>", "v_plaza" : "<?=$plaza?>" , "v_almacen" : "<?=$almacen?>"},
    success: function (response) {
      var dataJson = JSON.parse(response);
      $("#RealMes01").html("$"+numberWithCommas((+dataJson[0].FACTUR_TOTAL).toFixed(2)));
      $("#RealMes02").html("$"+numberWithCommas((+dataJson[1].FACTUR_TOTAL).toFixed(2)));
      $("#RealMes03").html("$"+numberWithCommas((+dataJson[2].FACTUR_TOTAL).toFixed(2)));
      $("#RealMes04").html("$"+numberWithCommas((+dataJson[3].FACTUR_TOTAL).toFixed(2)));
      $("#RealMes05").html("$"+numberWithCommas((+dataJson[4].FACTUR_TOTAL).toFixed(2)));
      $("#RealMes06").html("$"+numberWithCommas((+dataJson[5].FACTUR_TOTAL).toFixed(2)));
      $("#RealMes07").html("$"+numberWithCommas((+dataJson[6].FACTUR_TOTAL).toFixed(2)));
      $("#RealMes08").html("$"+numberWithCommas((+dataJson[7].FACTUR_TOTAL).toFixed(2)));
      $("#RealMes09").html("$"+numberWithCommas((+dataJson[8].FACTUR_TOTAL).toFixed(2)));
      $("#RealMes10").html("$"+numberWithCommas((+dataJson[9].FACTUR_TOTAL).toFixed(2)));
      $("#RealMes11").html("$"+numberWithCommas((+dataJson[10].FACTUR_TOTAL).toFixed(2)));
      $("#RealMes12").html("$"+numberWithCommas((+dataJson[11].FACTUR_TOTAL).toFixed(2)));

      var TotalRealMes = parseFloat(dataJson[0].FACTUR_TOTAL)+parseFloat(dataJson[1].FACTUR_TOTAL)+parseFloat(dataJson[2].FACTUR_TOTAL)+parseFloat(dataJson[3].FACTUR_TOTAL)+parseFloat(dataJson[4].FACTUR_TOTAL)+parseFloat(dataJson[5].FACTUR_TOTAL)+parseFloat(dataJson[6].FACTUR_TOTAL)+parseFloat(dataJson[7].FACTUR_TOTAL)+parseFloat(dataJson[8].FACTUR_TOTAL)+parseFloat(dataJson[9].FACTUR_TOTAL)+parseFloat(dataJson[10].FACTUR_TOTAL)+parseFloat(dataJson[11].FACTUR_TOTAL);
...
$('.clickInfo').on('click', function() {
  ...
  $('#modalInfoFac').modal('toggle');
   $.ajax({
    ...
    url: '../action/venta_AlmacenAjax.php',
    cache:false,
    data: { "modalDetFac" : 1, "pre" : <?=$pre?>, "fecha" : <?=$fecha?>, "v_promotor" : '<?=$promotor?>', "v_plaza" : '<?=$plaza?>', "mes" : $(this).data("info"), "v_almacen" : '<?=$almacen?>' },
    beforeSend: function (){
      ...
      $('#tablaDetFacturado').dataTable( {
        ...
        columns: [
          ...
          return "<b>"+total+"</b>"; } },
          {
            "data": null, render: function(data, type, row){
              var tipo;
                        if (data.FACTURADO_TOTAL >= 300000) {
                            tipo = "AAA";
                         }
                         else if (data.FACTURADO_TOTAL < 299999 && data.FACTURADO_TOTAL > 100000) {
                           tipo = "AA"
                         }
                         else {
                           tipo = "A"
...
<script type="text/javascript">
  ...
  function graficaPreVsVta (meses) {
    ...
    $promotor = "ALL";
    <?php $ventaReal = $insObj_VentaPromotor->ventaReal($pre,$fecha,$promotor,$plaza,$almacen) ?>
    ...
    for ($a=0; $a <4 ; $a++) {
      $var = array();
      $fecha_new = $fecha - (3-$a);
      $ventaRealAnio = $insObj_VentaPromotor->ventaReal($pre,$fecha_new,$promotor,$plaza,$almacen);
      for ($i=0; $i < count($ventaRealAnio) ; $i++) {
        $var[] = $ventaRealAnio[$i]["FACTUR_TOTAL"];
      }
      $comas = implode(",", $var);
    ?>
    var data<?=$a?> = [<?=$comas?>];
    ...
    $('#graficaPreVsVta').highcharts({
        chart: {
         ...
         title: {
          text: '<?php if( $pre == 3 ){ echo "RESULTADO PLAZA $fecha"; }else{echo "RESULTADO PROMOTOR $fecha";} ?>'
        },
        subtitle: {
...
$(function () {
    ...
    var categories = [
    <?php
    $grafica_Cliente = $insObj_VentaPromotor->informacionClientes($fecha,$promotor,$plaza,$almacen,$cliente);
     for ($i=0; $i <count($grafica_Cliente) ; $i++) {
        echo "'".$grafica_Cliente[$i]["NOM_MES"]."', ";
     }
    ?>
    ];
    var data1 = [
    ...
    $grafica_Cliente = $insObj_VentaPromotor->informacionClientes($fecha,$promotor,$plaza,$almacen,$cliente);
    for ($i=0; $i <count($grafica_Cliente) ; $i++) {
      echo $grafica_Cliente[$i]["FACTURADO_TOTAL"].",";
    }
    ?>
    ];
    var data2 = [
    <?php
    $grafica_Cliente2 = $insObj_VentaPromotor->informacionClientes($fecha-1,$promotor,$plaza,$almacen,$cliente);
    for ($i=0; $i <count($grafica_Cliente2) ; $i++) {
      echo $grafica_Cliente2[$i]["FACTURADO_TOTAL"].",";
    }
    ?>
    ];

    $('#graficaPreVsVta2').highcharts({
        chart: {
            type: 'column'
        },
         title: {
        ...
        series:  [{
          showInLegend:true,
            name: 'FACTURACION DEL CLIENTE <?php
              $nombreCliente = $insObj_VentaPromotor->clienteNombre($cliente);
              echo $nombreCliente[0]["CLIENTE"]; ?> DEL AÑO <?= $fecha ?>',
            data: data1,
        }, {
          showInLegend:true,
            name: 'FACTURACION DEL CLIENTE <?php
            $nombreCliente = $insObj_VentaPromotor->clienteNombre($cliente);
            echo $nombreCliente[0]["CLIENTE"];?> DEL AÑO <?= $fecha-1 ?>',
            data: data2,
        }]
...
<?php if ($plaza != 'ALL'){ ?>
  ...
  var categories = [
    <?php
    $grafica_Cliente2 = $insObj_VentaPromotor->informacionClientes($fecha,$promotor,$plaza,$almacen,$cliente);
    for ($i=0; $i < count($grafica_Cliente2) ; $i++) {
      echo "'".$grafica_Cliente2[$i]["NOM_MES"]."',";
    }
    ?>
  ];
  var data1 = [
