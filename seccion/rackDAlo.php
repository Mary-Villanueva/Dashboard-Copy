...
/*Proyecto Alo*/
  if ( isset($_POST["rtProyect"]))
  $_SESSION['rtProyect'] = $_POST['rtProyect'];
  $rtProyect = @$_SESSION['rtProyect'];
  #echo $rtProyect;
	...
	<section>
	  <div class="box box-info">
	    <div class="box-header with-border">
	      <h5 class="box-title"><i class="fa fa-search"></i> Filtros y Búsquedas de Mercancía (BAJIO)</h5>
	    ...
	    <div class="box-body"><!--box-body-->
	    	...
	    	<!-- SELECT OPTION PLAZA -->
	    	<div class="col-md-2 col-sm-2 col-xs-12 invoice-col" style="display:none;">
	    	...
	    	<form method="post">
		        ...
		        <address>
		          ...
		          if ( isset($id_plaza) && !empty($id_plaza) ){//if
		          	$selectAlmacen = $objRack->selectAlmacen(8);
            ...
            <input type="hidden" name="rtProyect" value="">
		        </address>
		    </form>
		    </div>
        ...
        <div class="col-md-2 col-sm-2 col-xs-12 invoice-col">
        <form method="post">
            <strong><i class="fa fa-cube"></i> Proyecto:</strong>
            <address>
              <select class="form-control select2" name="rtProyect" style='width: 100%;' onchange='this.form.submit()'>
              <option selected="true" disabled>Seleccione El Proyecto</option>
              <?php
              $selectProyecto = $objRack->selectProyecto();
              if ($rtProyect == 'ALL'){ echo '<option selected value="ALL">ALL</option>';}else{echo '<option value="ALL">ALL</option>';}
              for ($i=0; $i <count($selectProyecto) ; $i++) {
            ?>
            <option <?php if (@$rtProyect == $selectProyecto[$i]["V_PROYECTO"]) echo "selected"; ?> value="<?=$selectProyecto[$i]["V_PROYECTO"]?>">
              (<?=$selectProyecto[$i]["V_PROYECTO"]?>)--<?=$selectProyecto[$i]["V_PROYECTO"]?>
            </option>
            <?php
              }
            ?>
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="box box-default box-solid"><!-- box -->
					...
					function DetalleUbica(id_plaza,id_almacen,id_cliente,mercancia,rack,profundidad,rtProyect){

						//console.log(id_plaza+" -- "+id_almacen+" -- "+id_cliente+" -- "+mercancia+" -- "+rack+" -- "+profundidad);
						$.ajax({
                            type: 'POST',
	                        url: '../action/rackAjaxAlo.php',
	                        cache:false,
                            data: {"DibMerca" : 1, "id_plaza" : id_plaza, "id_almacen" : id_almacen, "id_cliente" : id_cliente, "mercancia" : mercancia, "rack" : rack, "profundidad" : profundidad, "rtProyect" : rtProyect},
                            success: function (response) {//success
                              //alert(id_plaza + "  " + id_almacen + "  " + id_cliente + "  "  + mercancia + "  "+ rack+ "  "+ profundidad +"   "+rtProyect);
                ...
                var saldo = $.trim(dataJson[k].SALDO);
                            ...
                            if (v_ubicacion == 'A01040301') {
                              //alert(saldo+ '  '+v_detalle);
                            }
                            if ( v_detalle == ""  || v_detalle === 'undefined' || saldo == 0 ){
                              //alert(saldo + '  ' + v_ubicacion);
                              if (v_ubicacion == 'A01040301') {
                                //alert("gere");
                              }
	                   		    	$("#imgUrl"+v_ubicacion).replaceWith('<a class="fancybox fancybox.iframe" href="rack_detubiAlo.php?detUbi='+v_ubicacion+'&p=<?=$id_plaza?>&c=<?=$id_cliente?>&a=<?=$id_almacen?>&m=<?=$mercancia?>&proyecto=<?=$rtProyect?>&tipo=2"><img class="v_libre itemMer" id="imgUrl'+v_ubicacion+'" data-info="libre '+(v_ubicacion).toLowerCase()+'" style="vertical-align: text-bottom;" width="40" height="22" src="data:image/png;base64," ></a>');
...
<!-- ===================================================== /.CONSULTA DE COLUMNAS DENTRO DE DEL FOR ===================================================== -->
                    	...
                    	<script type="text/javascript">
                    		DetalleUbica(<?=$id_plaza?>,<?=$id_almacen?>,'<?=$id_cliente?>','<?=$mercancia?>','<?=$rackProfundidad[$i]["RACK"]?>','<?=$rackProfundidad[$i]["PROFUNDIDAD"]?>', '<?=$rtProyect?>');
                    	</script>
            ...
            <!-- INICIA SECCION MERCANCIA CUARENTENA -->
            <section>
              <div class="row">
                <div class="col-xs-12">
                  <div class="box box-default box-solid"><!-- box -->
                    <div class="box-header"><!-- box-header -->
                      <h3 class="box-title"><i class="fa fa-dropbox"></i> Mercancía Cuarentena </h3>
                    ...
                    <div class="box-body"><!-- box-body rack dibujo -->
                    <div style="height: auto; overflow: auto;"><!-- overflow #2 -->
	                  ...
	                  <div class="row liMerNoUbi">
	                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 center">
	                      <ul class="users-list"><!-- users-list -->
	                      	...
	                      	<?php
	                      	$mercanciaNoUbi = $objRack->mercanciaNoUbi($id_plaza,$id_almacen,$id_cliente,$mercancia, $rtProyect);
	                      	for ($i=0; $i <count($mercanciaNoUbi) ; $i++) {// for mercanciaNoUbi
	                      	$detalle = str_replace ("\r\n", "<\br>", $mercanciaNoUbi[$i]["V_DETALLE"]);
	                      	$detalle = str_replace("\"", '', $detalle);
	                      	?>
							<li>
							  <a class="fancybox fancybox.iframe" href="rack_detubiAlo.php?detArr=<?=$mercanciaNoUbi[$i]["ID_ARRIBO"]?>&p=<?=$id_plaza?>&c=<?=$id_cliente?>&a=<?=$id_almacen?>&m=<?=$mercancia?>&proyecto=<?=$rtProyect?>&tipo=1">
            ...
            <!-- TERMINA SECCION MERCANCIA CUARENTENA -->
            ...
            <section>
              <div class="row">
                <div class="col-xs-12">
                  <div class="box box-default box-solid"><!-- box -->
                    <div class="box-header"><!-- box-header -->
                      <h3 class="box-title"><i class="fa fa-dropbox"></i> Mercancía Stage </h3>
	                  ...
	                  <div class="row liMerNoUbi">
	                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 center">
	                      <ul class="users-list"><!-- users-list -->
	                      	...
	                      	<!-- inicia for li mercancia no ubicada -->
	                      	<?php
	                      	$mercanciaNoUbi = $objRack->mercanciaNoUbiStage($id_plaza,$id_almacen,$id_cliente,$mercancia, $rtProyect);
	                      	for ($i=0; $i <count($mercanciaNoUbi) ; $i++) {// for mercanciaNoUbi
	                      	$detalle = str_replace ("\r\n", "<\br>", $mercanciaNoUbi[$i]["V_DETALLE"]);
	                      	$detalle = str_replace("\"", '', $detalle);
	                      	?>
							<li>
							  <a class="fancybox fancybox.iframe" href="rack_detubiAlo.php?detArr=<?=$mercanciaNoUbi[$i]["ID_ARRIBO"]?>&p=<?=$id_plaza?>&c=<?=$id_cliente?>&a=<?=$id_almacen?>&m=<?=$mercancia?>&proyecto=<?=$rtProyect?>&tipo=2">
							  <img id="imgUrl<?=$mercanciaNoUbi[$i]["ID_ARRIBO"]?>" class="v_noubi itemMer" data-info="no ubicado <?=strtolower($mercanciaNoUbi[$i]["ID_ARRIBO"].' '.$detalle)?>" width="60" height="60" src="data:image/jpeg;base64,"></a>
							  <span style="font-size:10px;" class="label bg-gray itemMer"><?=$mercanciaNoUbi[$i]["ID_ARRIBO"]?></span>
		                    </li>
	                  ...
	                  <div class="row liMerNoUbi">
	                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 center">
	                      <ul class="users-list"><!-- users-list -->
	                      	...
	                      	<!-- inicia for li mercancia no ubicada -->
	                      	<?php
	                      	$mercanciaNoUbi = $objRack->mercanciaNoUbiNacional($id_plaza,$id_almacen,$id_cliente,$mercancia, $rtProyect);
	                      	for ($i=0; $i <count($mercanciaNoUbi) ; $i++) {// for mercanciaNoUbi
	                      	$detalle = str_replace ("\r\n", "<\br>", $mercanciaNoUbi[$i]["V_DETALLE"]);
	                      	$detalle = str_replace("\"", '', $detalle);
	                      	?>
							<li>
							  <a class="fancybox fancybox.iframe" href="rack_detubiAlo.php?detArr=<?=$mercanciaNoUbi[$i]["ID_ARRIBO"]?>&p=<?=$id_plaza?>&c=<?=$id_cliente?>&a=<?=$id_almacen?>&m=<?=$mercancia?>&proyecto=<?=$rtProyect?>&tipo=3">
							  <img id="imgUrl<?=$mercanciaNoUbi[$i]["ID_ARRIBO"]?>" class="v_noubi itemMer" data-info="no ubicado <?=strtolower($mercanciaNoUbi[$i]["ID_ARRIBO"].' '.$detalle)?>" width="60" height="60" src="data:image/jpeg;base64,"></a>
							  <span style="font-size:10px;" class="label bg-gray itemMer"><?=$mercanciaNoUbi[$i]["ID_ARRIBO"]?></span>
		                    </li>
